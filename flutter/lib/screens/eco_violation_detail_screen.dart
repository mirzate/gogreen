...
class EcoViolationDetailScreen extends StatefulWidget {
  ...
  @override
  State<EcoViolationDetailScreen> createState() =>
      _EcoViolationDetailScreenState();
}
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      widget.Ecoviolation.title.toString(),
                      style:
                    ...
                    Divider(),
                    Text(
                        'Status: ${widget.Ecoviolation.ecoViolationStatus?.name}'),
                    Text(
                        'Municipality: ${widget.Ecoviolation.municipality?.title}'),
                    Text(
                        'Municipality Response: ${widget.Ecoviolation.response}'),
